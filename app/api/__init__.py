...
from .profile_revisions import router as profile_revisions_router
from .audit_reports import router as audit_reports_router
...
api_router.include_router(profile_revisions_router)
